// Modificado por Karina Pacheco e Wesley Xavier
// ESD | 2022.3
...
void ImprimeMenu() {
  ...
  printf("t <valor> para imprimir a altura de um no da arvore\n");
  printf("w <valor> para imprimir o numero de nos maiores\n");
